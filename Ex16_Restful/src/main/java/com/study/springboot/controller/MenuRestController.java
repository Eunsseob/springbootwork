...
public class MenuRestController {
	...
	public List<com.study.springboot.domain.Menu> findByType(@PathVariable(name="type") Type type){
		return mService.findByType(type);
	}
	
	@GetMapping("/type/{type}/taste/{taste}")
	public List<com.study.springboot.domain.Menu> findByTypeAndTaste(@PathVariable(name="type") Type type,
